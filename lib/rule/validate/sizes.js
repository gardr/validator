...
internals.outputAdformThreshold = function (dataSummary, report /*, options*/ ) {
    if (!dataSummary || !dataSummary.typed || !dataSummary.typed.types || !dataSummary.typed.types.script) {
        return;
    }

    var size = 0;
    var data = dataSummary.typed.types.script;
